...
Santa correria! Será que, com o passar do tempo, o ritmo continuou o mesmo ou os membros da banda se cansaram e preferiram ficar mais numa boa? A razão dias/show ao longo dos anos de carreira da banda é um bom indicador dessa questão:

```{r}
# Gráfico da razão shows/dia
